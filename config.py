...
def _load_cf_exports() -> dict:
    ...
    try:
        ...
        # AgentCore's least-privilege runtime role intentionally has no
        # CloudFormation access. Runtime resource names are supplied as env vars.
        pass
    return exports
...
def _get(key: str, fallback_env: str = None) -> str:
    ...
    value = _exports.get(f"{PROJECT_NAME}-{key}") or os.environ.get(key, '')
